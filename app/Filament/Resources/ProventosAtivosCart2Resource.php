...
use App\Filament\Resources\ProventosAtivosCart2Resource\Pages;
use App\Filament\Resources\ProventosAtivosCart2Resource\RelationManagers;
use App\Models\Ativo;
use App\Models\ProventoAtivosCart02;
use Filament\Forms;
...
class ProventosAtivosCart2Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Fernando';
    ...
    protected static function getMonthlyProventoColumns(): array
{
    ...
    $periods = ProventoAtivosCart02::query()
    ...
    $columns[] = Tables\Columns\TextColumn::make("provento_pre_2025")
        ...
        ->getStateUsing(function ($record) {
            return ProventoAtivosCart02::query()
...
*/
    ...
    {
        return [
            'index' => Pages\ListProventosAtivosCart2s::route('/'),

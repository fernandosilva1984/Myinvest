...
use App\Filament\Resources\ProventosAtivosCart3Resource\Pages;
use App\Filament\Resources\ProventosAtivosCart3Resource\RelationManagers;
use App\Models\Ativo;
use App\Models\ProventoAtivosCart03;
use Filament\Forms;
...
class ProventosAtivosCart3Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Líbina';
    ...
    protected static function getMonthlyProventoColumns(): array
{
    ...
    $periods = ProventoAtivosCart03::query()
    ...
    $columns[] = Tables\Columns\TextColumn::make("provento_pre_2025")
        ...
        ->getStateUsing(function ($record) {
            return ProventoAtivosCart03::query()
...
*/
    ...
    {
        return [
            'index' => Pages\ListProventosAtivosCart3s::route('/'),

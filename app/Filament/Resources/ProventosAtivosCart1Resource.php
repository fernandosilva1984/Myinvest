...
use App\Filament\Resources\ProventosAtivosCart1Resource\Pages;
use App\Filament\Resources\ProventosAtivosCart1Resource\RelationManagers;
use App\Models\Ativo;
use App\Models\ProventoAtivosCart01;
use Filament\Forms;
...
class ProventosAtivosCart1Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Marina';
    ...
    protected static function getMonthlyProventoColumns(): array
{
    ...
    $periods = ProventoAtivosCart01::query()

...
use App\Filament\Resources\ProventosAtivosCart5Resource\Pages;
use App\Filament\Resources\ProventosAtivosCart5Resource\RelationManagers;
use App\Models\Ativo;
use App\Models\ProventoAtivosCart05;
use Filament\Forms;
...
class ProventosAtivosCart5Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Dona Lita';
    ...
    protected static function getMonthlyProventoColumns(): array
{
    ...
    $periods = ProventoAtivosCart05::query()
    ...
    $columns[] = Tables\Columns\TextColumn::make("provento_pre_2025")
        ...
        ->getStateUsing(function ($record) {
            return ProventoAtivosCart05::query()
...
*/
    ...
    {
        return [
            'index' => Pages\ListProventosAtivosCart5s::route('/'),
